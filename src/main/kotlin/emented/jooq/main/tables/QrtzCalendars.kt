...
open class QrtzCalendars(
     ...
     */
    val SCHED_NAME: TableField<QrtzCalendarsRecord, String?> =
     ...
     */
    val CALENDAR_NAME: TableField<QrtzCalendarsRecord, String?> =
        createField(DSL.name("calendar_name"), SQLDataType.VARCHAR(200).nullable(false), this, "")

    /**
     * The column <code>public.qrtz_calendars.calendar</code>.
     */
    val CALENDAR: TableField<QrtzCalendarsRecord, ByteArray?> =
        createField(DSL.name("calendar"), SQLDataType.BLOB.nullable(false), this, "")

    private constructor(alias: Name, aliased: Table<QrtzCalendarsRecord>?) : this(
        alias,
        null,
        null,
        null,
    ...
    private constructor(alias: Name, aliased: Table<QrtzCalendarsRecord>?, parameters: Array<Field<*>?>?) : this(
        alias,
        null,
        null,
        null,
    ...
    private constructor(alias: Name, aliased: Table<QrtzCalendarsRecord>?, where: Condition?) : this(
        alias,
        null,
        null,
        null,
     ...
     */
    override fun where(condition: Condition?): QrtzCalendars =
        QrtzCalendars(qualifiedName, if (aliased()) this else null, condition)
     ...
     */
    @PlainSQL
    override fun where(condition: SQL): QrtzCalendars = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL
    override fun where(@Stringly.SQL condition: String): QrtzCalendars = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL
    override fun where(@Stringly.SQL condition: String, vararg binds: Any?): QrtzCalendars =
     ...
     */
    @PlainSQL
    override fun where(@Stringly.SQL condition: String, vararg parts: QueryPart): QrtzCalendars =
