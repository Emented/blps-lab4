...
open class CommunityRecord() : UpdatableRecordImpl<CommunityRecord>(Community.COMMUNITY) {
     ...
     */
    constructor(id: Long? = null, name: String? = null, address: String? = null, language: String? = null, description: String? = null, isForChildren: Boolean? = null, categoryId: Long? = null, userId: Long? = null, isBlocked: Boolean? = null, interestRate: Long? = null, moderationResult: String? = null, moderationMessage: String? = null, creationTs: OffsetDateTime? = null, updateTs: OffsetDateTime? = null): this() {
        this.id = id
        this.name = name
