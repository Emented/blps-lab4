...
open class Category(
    ...
    private constructor(alias: Name, aliased: Table<CategoryRecord>?) : this(
        alias,
        null,
        null,
        null,
    ...
    private constructor(alias: Name, aliased: Table<CategoryRecord>?, parameters: Array<Field<*>?>?) : this(
        alias,
        null,
        null,
        null,
    ...
    private constructor(alias: Name, aliased: Table<CategoryRecord>?, where: Condition?) : this(
        alias,
        null,
        null,
        null,
    ...
    constructor(
        ...
        childPath: ForeignKey<out Record, CategoryRecord>?,
        parentPath: InverseForeignKey<out Record, CategoryRecord>?
    ) : this(Internal.createPathAlias(path, childPath, parentPath), path, childPath, parentPath, CATEGORY, null, null)
    ...
    fun communityEvent(): CommunityEventPath {
        if (!this::_communityEvent.isInitialized)
            _communityEvent =
                CommunityEventPath(this, null, COMMUNITY_EVENT__COMMUNITY_EVENT_CATEGORY_ID_FKEY.inverseKey)
     ...
     */
    override fun where(condition: Condition?): Category =
        Category(qualifiedName, if (aliased()) this else null, condition)
     ...
     */
    @PlainSQL
    override fun where(condition: SQL): Category = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL
    override fun where(@Stringly.SQL condition: String): Category = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL
    override fun where(@Stringly.SQL condition: String, vararg binds: Any?): Category =
     ...
     */
    @PlainSQL
    override fun where(@Stringly.SQL condition: String, vararg parts: QueryPart): Category =
