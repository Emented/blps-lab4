...
open class QrtzPausedTriggerGrps(
     ...
     */
    val SCHED_NAME: TableField<QrtzPausedTriggerGrpsRecord, String?> = createField(DSL.name("sched_name"), SQLDataType.VARCHAR(120).nullable(false), this, "")

    /**
     * The column <code>public.qrtz_paused_trigger_grps.trigger_group</code>.
     */
    val TRIGGER_GROUP: TableField<QrtzPausedTriggerGrpsRecord, String?> = createField(DSL.name("trigger_group"), SQLDataType.VARCHAR(200).nullable(false), this, "")

    private constructor(alias: Name, aliased: Table<QrtzPausedTriggerGrpsRecord>?): this(alias, null, null, null, aliased, null, null)
    private constructor(alias: Name, aliased: Table<QrtzPausedTriggerGrpsRecord>?, parameters: Array<Field<*>?>?): this(alias, null, null, null, aliased, parameters, null)
    private constructor(alias: Name, aliased: Table<QrtzPausedTriggerGrpsRecord>?, where: Condition?): this(alias, null, null, null, aliased, null, where)
     ...
     */
    override fun where(condition: Condition?): QrtzPausedTriggerGrps = QrtzPausedTriggerGrps(qualifiedName, if (aliased()) this else null, condition)
     ...
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(condition: SQL): QrtzPausedTriggerGrps = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String): QrtzPausedTriggerGrps = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String, vararg binds: Any?): QrtzPausedTriggerGrps = where(DSL.condition(condition, *binds))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String, vararg parts: QueryPart): QrtzPausedTriggerGrps = where(DSL.condition(condition, *parts))
