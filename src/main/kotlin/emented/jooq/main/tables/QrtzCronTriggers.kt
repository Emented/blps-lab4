...
open class QrtzCronTriggers(
     ...
     */
    val SCHED_NAME: TableField<QrtzCronTriggersRecord, String?> = createField(DSL.name("sched_name"), SQLDataType.VARCHAR(120).nullable(false), this, "")

    /**
     * The column <code>public.qrtz_cron_triggers.trigger_name</code>.
     */
    val TRIGGER_NAME: TableField<QrtzCronTriggersRecord, String?> = createField(DSL.name("trigger_name"), SQLDataType.VARCHAR(200).nullable(false), this, "")

    /**
     * The column <code>public.qrtz_cron_triggers.trigger_group</code>.
     */
    val TRIGGER_GROUP: TableField<QrtzCronTriggersRecord, String?> = createField(DSL.name("trigger_group"), SQLDataType.VARCHAR(200).nullable(false), this, "")

    /**
     * The column <code>public.qrtz_cron_triggers.cron_expression</code>.
     */
    val CRON_EXPRESSION: TableField<QrtzCronTriggersRecord, String?> = createField(DSL.name("cron_expression"), SQLDataType.VARCHAR(120).nullable(false), this, "")

    /**
     * The column <code>public.qrtz_cron_triggers.time_zone_id</code>.
     */
    val TIME_ZONE_ID: TableField<QrtzCronTriggersRecord, String?> = createField(DSL.name("time_zone_id"), SQLDataType.VARCHAR(80), this, "")

    private constructor(alias: Name, aliased: Table<QrtzCronTriggersRecord>?): this(alias, null, null, null, aliased, null, null)
    private constructor(alias: Name, aliased: Table<QrtzCronTriggersRecord>?, parameters: Array<Field<*>?>?): this(alias, null, null, null, aliased, parameters, null)
    private constructor(alias: Name, aliased: Table<QrtzCronTriggersRecord>?, where: Condition?): this(alias, null, null, null, aliased, null, where)
    ...
    constructor(path: Table<out Record>, childPath: ForeignKey<out Record, QrtzCronTriggersRecord>?, parentPath: InverseForeignKey<out Record, QrtzCronTriggersRecord>?): this(Internal.createPathAlias(path, childPath, parentPath), path, childPath, parentPath, QRTZ_CRON_TRIGGERS, null, null)

    /**
     * A subtype implementing {@link Path} for simplified path-based joins.
     */
    open class QrtzCronTriggersPath : QrtzCronTriggers, Path<QrtzCronTriggersRecord> {
        constructor(path: Table<out Record>, childPath: ForeignKey<out Record, QrtzCronTriggersRecord>?, parentPath: InverseForeignKey<out Record, QrtzCronTriggersRecord>?): super(path, childPath, parentPath)
    ...
    override fun getReferences(): List<ForeignKey<QrtzCronTriggersRecord, *>> = listOf(QRTZ_CRON_TRIGGERS__QRTZ_CRON_TRIGGERS_SCHED_NAME_TRIGGER_NAME_TRIGGER_GROUP_FKEY)
    ...
    fun qrtzTriggers(): QrtzTriggersPath {
        if (!this::_qrtzTriggers.isInitialized)
            _qrtzTriggers = QrtzTriggersPath(this, QRTZ_CRON_TRIGGERS__QRTZ_CRON_TRIGGERS_SCHED_NAME_TRIGGER_NAME_TRIGGER_GROUP_FKEY, null)
     ...
     */
    override fun where(condition: Condition?): QrtzCronTriggers = QrtzCronTriggers(qualifiedName, if (aliased()) this else null, condition)
     ...
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(condition: SQL): QrtzCronTriggers = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String): QrtzCronTriggers = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String, vararg binds: Any?): QrtzCronTriggers = where(DSL.condition(condition, *binds))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String, vararg parts: QueryPart): QrtzCronTriggers = where(DSL.condition(condition, *parts))
