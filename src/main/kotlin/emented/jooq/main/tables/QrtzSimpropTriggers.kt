...
open class QrtzSimpropTriggers(
     ...
     */
    val SCHED_NAME: TableField<QrtzSimpropTriggersRecord, String?> =
     ...
     */
    val TRIGGER_NAME: TableField<QrtzSimpropTriggersRecord, String?> =
     ...
     */
    val TRIGGER_GROUP: TableField<QrtzSimpropTriggersRecord, String?> =
     ...
     */
    val STR_PROP_1: TableField<QrtzSimpropTriggersRecord, String?> =
        createField(DSL.name("str_prop_1"), SQLDataType.VARCHAR(512), this, "")

    /**
     * The column <code>public.qrtz_simprop_triggers.str_prop_2</code>.
     */
    val STR_PROP_2: TableField<QrtzSimpropTriggersRecord, String?> =
        createField(DSL.name("str_prop_2"), SQLDataType.VARCHAR(512), this, "")

    /**
     * The column <code>public.qrtz_simprop_triggers.str_prop_3</code>.
     */
    val STR_PROP_3: TableField<QrtzSimpropTriggersRecord, String?> =
        createField(DSL.name("str_prop_3"), SQLDataType.VARCHAR(512), this, "")

    /**
     * The column <code>public.qrtz_simprop_triggers.int_prop_1</code>.
     */
    val INT_PROP_1: TableField<QrtzSimpropTriggersRecord, Int?> =
        createField(DSL.name("int_prop_1"), SQLDataType.INTEGER, this, "")

    /**
     * The column <code>public.qrtz_simprop_triggers.int_prop_2</code>.
     */
    val INT_PROP_2: TableField<QrtzSimpropTriggersRecord, Int?> =
        createField(DSL.name("int_prop_2"), SQLDataType.INTEGER, this, "")

    /**
     * The column <code>public.qrtz_simprop_triggers.long_prop_1</code>.
     */
    val LONG_PROP_1: TableField<QrtzSimpropTriggersRecord, Long?> =
        createField(DSL.name("long_prop_1"), SQLDataType.BIGINT, this, "")

    /**
     * The column <code>public.qrtz_simprop_triggers.long_prop_2</code>.
     */
    val LONG_PROP_2: TableField<QrtzSimpropTriggersRecord, Long?> =
        createField(DSL.name("long_prop_2"), SQLDataType.BIGINT, this, "")

    /**
     * The column <code>public.qrtz_simprop_triggers.dec_prop_1</code>.
     */
    val DEC_PROP_1: TableField<QrtzSimpropTriggersRecord, BigDecimal?> =
        createField(DSL.name("dec_prop_1"), SQLDataType.NUMERIC(13, 4), this, "")

    /**
     * The column <code>public.qrtz_simprop_triggers.dec_prop_2</code>.
     */
    val DEC_PROP_2: TableField<QrtzSimpropTriggersRecord, BigDecimal?> =
        createField(DSL.name("dec_prop_2"), SQLDataType.NUMERIC(13, 4), this, "")

    /**
     * The column <code>public.qrtz_simprop_triggers.bool_prop_1</code>.
     */
    val BOOL_PROP_1: TableField<QrtzSimpropTriggersRecord, Boolean?> =
        createField(DSL.name("bool_prop_1"), SQLDataType.BOOLEAN, this, "")

    /**
     * The column <code>public.qrtz_simprop_triggers.bool_prop_2</code>.
     */
    val BOOL_PROP_2: TableField<QrtzSimpropTriggersRecord, Boolean?> =
        createField(DSL.name("bool_prop_2"), SQLDataType.BOOLEAN, this, "")

    private constructor(alias: Name, aliased: Table<QrtzSimpropTriggersRecord>?) : this(
        alias,
        null,
        null,
        null,
    ...
    private constructor(alias: Name, aliased: Table<QrtzSimpropTriggersRecord>?, parameters: Array<Field<*>?>?) : this(
        alias,
        null,
        null,
        null,
    ...
    private constructor(alias: Name, aliased: Table<QrtzSimpropTriggersRecord>?, where: Condition?) : this(
        alias,
        null,
        null,
        null,
    ...
    override fun getReferences(): List<ForeignKey<QrtzSimpropTriggersRecord, *>> =
        listOf(QRTZ_SIMPROP_TRIGGERS__QRTZ_SIMPROP_TRIGGERS_SCHED_NAME_TRIGGER_NAME_TRIGGER_GROU_FKEY)
    ...
    fun qrtzTriggers(): QrtzTriggersPath {
        if (!this::_qrtzTriggers.isInitialized)
            _qrtzTriggers = QrtzTriggersPath(
                this,
                QRTZ_SIMPROP_TRIGGERS__QRTZ_SIMPROP_TRIGGERS_SCHED_NAME_TRIGGER_NAME_TRIGGER_GROU_FKEY,
                null
            )
     ...
     */
    override fun where(condition: Condition?): QrtzSimpropTriggers =
        QrtzSimpropTriggers(qualifiedName, if (aliased()) this else null, condition)
     ...
     */
    @PlainSQL
    override fun where(condition: SQL): QrtzSimpropTriggers = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL
    override fun where(@Stringly.SQL condition: String): QrtzSimpropTriggers = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL
    override fun where(@Stringly.SQL condition: String, vararg binds: Any?): QrtzSimpropTriggers =
     ...
     */
    @PlainSQL
    override fun where(@Stringly.SQL condition: String, vararg parts: QueryPart): QrtzSimpropTriggers =
