...
open class Community(
     ...
     */
    val IS_FOR_CHILDREN: TableField<CommunityRecord, Boolean?> =
     ...
     */
    val INTEREST_RATE: TableField<CommunityRecord, Long?> =
     ...
     */
    val MODERATION_RESULT: TableField<CommunityRecord, String?> =
        createField(DSL.name("moderation_result"), SQLDataType.VARCHAR(64).nullable(false), this, "")

    /**
     * The column <code>public.community.moderation_message</code>.
     */
    val MODERATION_MESSAGE: TableField<CommunityRecord, String?> =
        createField(DSL.name("moderation_message"), SQLDataType.VARCHAR(255), this, "")

    /**
     * The column <code>public.community.creation_ts</code>.
     */
    val CREATION_TS: TableField<CommunityRecord, OffsetDateTime?> =
     ...
     */
    val UPDATE_TS: TableField<CommunityRecord, OffsetDateTime?> =
        createField(DSL.name("update_ts"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "")

    private constructor(alias: Name, aliased: Table<CommunityRecord>?) : this(
        alias,
        null,
        null,
        null,
    ...
    private constructor(alias: Name, aliased: Table<CommunityRecord>?, parameters: Array<Field<*>?>?) : this(
        alias,
        null,
        null,
        null,
    ...
    private constructor(alias: Name, aliased: Table<CommunityRecord>?, where: Condition?) : this(
        alias,
        null,
        null,
        null,
    ...
    constructor(
        ...
        childPath: ForeignKey<out Record, CommunityRecord>?,
        parentPath: InverseForeignKey<out Record, CommunityRecord>?
    ) : this(Internal.createPathAlias(path, childPath, parentPath), path, childPath, parentPath, COMMUNITY, null, null)
    ...
    override fun getIdentity(): Identity<CommunityRecord, Long?> =
        super.getIdentity() as Identity<CommunityRecord, Long?>
    ...
    override fun getReferences(): List<ForeignKey<CommunityRecord, *>> = listOf(COMMUNITY__COMMUNITY_CATEGORY_ID_FKEY)
     ...
     */
    override fun where(condition: Condition?): Community =
        Community(qualifiedName, if (aliased()) this else null, condition)
     ...
     */
    @PlainSQL
    override fun where(condition: SQL): Community = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL
    override fun where(@Stringly.SQL condition: String): Community = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL
    override fun where(@Stringly.SQL condition: String, vararg binds: Any?): Community =
     ...
     */
    @PlainSQL
    override fun where(@Stringly.SQL condition: String, vararg parts: QueryPart): Community =
