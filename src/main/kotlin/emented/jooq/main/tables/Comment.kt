...
open class Comment(
     ...
     */
    val TEXT_VALUE: TableField<CommentRecord, String?> = createField(DSL.name("text_value"), SQLDataType.CLOB.nullable(false), this, "")

    /**
     * The column <code>public.comment.created_at</code>.
     */
    val CREATED_AT: TableField<CommentRecord, OffsetDateTime?> = createField(DSL.name("created_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "")

    /**
     * The column <code>public.comment.updated_at</code>.
     */
    val UPDATED_AT: TableField<CommentRecord, OffsetDateTime?> = createField(DSL.name("updated_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "")

    /**
     * The column <code>public.comment.community_id</code>.
     */
    val COMMUNITY_ID: TableField<CommentRecord, Long?> = createField(DSL.name("community_id"), SQLDataType.BIGINT.nullable(false), this, "")

    /**
     * The column <code>public.comment.user_id</code>.
     */
    val USER_ID: TableField<CommentRecord, Long?> = createField(DSL.name("user_id"), SQLDataType.BIGINT.nullable(false), this, "")
    ...
    override fun getReferences(): List<ForeignKey<CommentRecord, *>> = listOf(COMMENT__COMMENT_COMMUNITY_ID_FKEY, COMMENT__COMMENT_USER_ID_FKEY)
    ...
    fun user(): UserPath {
        if (!this::_user.isInitialized)
            _user = UserPath(this, COMMENT__COMMENT_USER_ID_FKEY, null)
